...
cast:
  ...
  - role: Second Officer
    name: Mike Sanders
  - role: Lord attending on Orsino
    name: Zulfiquar Dalal
  - role: Viola, later disguised as Cesario
    name: Zoe Brown
  - role: Sebastian, her twin brother
    name: Simon Evison
  - role: Captain of the wrecked ship
    name: Mike Horn
  - role: Antonio, another sea-captain
    name: Anthony Cooke
  - role: Olivia, a Countess
    name: Jo Bloom
  - role: Maria, her waiting-gentlewoman
    name: Nicole Ross-Anderson
  - role: Sir Toby Belch, Olivia's kinsman
    name: Ross Parish
  - role: Sir Andrew Aguecheek
    name: Andrew Watson
  - role: Malvolio, Olivia's steward
    name: Jonathan Urquhart
  - role: Fabian, Olivia's manservant
    name: Paul Ham
  - role: Feste, Olivia's jester
    name: Stuart Scott
  - role: Priest
    name: Chris O'Mearle
  - role: Servant to Olivia
    name: Debbie Payne
  - role: Manservant to Olivia
    name: Mike Horn
...
The programme thanks The Golden Cage and Trent Security, "and all those who helped in any way…".

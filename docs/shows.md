...
| `date_start` | Date of first performance | *Format under review* |
| `date_end` | Date of last performance | *Format under review* |
...
| `photos` | Production shots | Uses the [photos and assets](/docs/photos_and_assets) |
| `assets` | Publicity and other materials | Uses the [photos and assets](/docs/photos_and_assets) |

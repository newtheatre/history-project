...
class Lightbox
    ...
    addElement: ->
        ...
        document.querySelector('.lightbox-box__prev').addEventListener('click', @prevImage)
        document.querySelector('.lightbox-box__next').addEventListener('click', @nextImage)
        document.querySelector('.lightbox-box__close').addEventListener('click', @close)

        # Save ref to load spinner
        @loadSpinnerEl = document.querySelector('.lightbox-box__load')
        @imageEl = document.querySelector('.lightbox-box__image')
